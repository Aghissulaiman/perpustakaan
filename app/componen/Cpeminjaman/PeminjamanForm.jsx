  ...
  useEffect(() => {
    ...
    async function fetchData() {
      try {
        ...
        // ambil buku langsung berdasarkan id (lebih reliable)
        ...
        // set tanggal kembali default +14 hari
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="bg-white p-8 rounded-xl shadow-xl text-center border-t-4 border-red-500">
          <h2 className="text-2xl font-bold text-red-600 mb-3">Data Tidak Ditemukan 🚫</h2>
          <Link
            href="/home"
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="rounded-lg border border-gray-200 shadow-sm overflow-hidden">
              <div className="bg-blue-600 text-white font-bold text-lg p-3">👤 Data Peminjam</div>
            ...
            <div className="rounded-lg border border-gray-200 shadow-sm overflow-hidden">
              <div className="bg-blue-600 text-white font-bold text-lg p-3">📚 Detail Buku</div>
              ...
              <DataRow
                label="Stok"
                value={
                  <span className={`font-bold ${book.stok > 0 ? "text-green-600" : "text-red-600"}`}>
                    {book.stok}
                  </span>
                }
              />
              ...
              />
              {book.isbn && <DataRow label="ISBN" value={book.isbn} />}
            </div>
          </div>
          ...
          <div className="flex justify-center gap-4 pt-4">
            ...
            <button
              ...
              className={`px-8 py-3 rounded-lg font-semibold text-white shadow-md ${
                isSubmitting || book.stok <= 0 ? "bg-blue-400 cursor-not-allowed" : "bg-blue-600 hover:bg-blue-700"
              }`}
            >
              {isSubmitting ? "Mengajukan..." : book.stok <= 0 ? "Stok Habis" : "Ajukan Peminjaman ✅"}
            </button>
          </div>
        </form>
      </div>
